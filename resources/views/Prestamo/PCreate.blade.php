...
<br><br>
<form  method="POST" action="{{route('prestamo.crear')}}" class0="needs-validation">
@csrf

<div class="container" style="max-width: 600px;" >  
<div class="card">
  <h4 class="card-header"><center><b><ul>CREAR DATOS DEL PRESTAMO</ul></b></center></h4>
    <div class="card">
    <div class="card-body">
    ...
    name="fecha_solicitud"  id="fecha_solicitud" placeholder="Ingrese la Fecha" value="{{old('fecha_solicitud')}}">
    ...
    name="fecha_prestamo"  id="fecha_prestamo" placeholder="Ingrese la Fecha" value="{{old('fecha_prestamo')}}">
    ...
    name="fecha_devolucion"  id="fecha_devolucion" placeholder="Ingrese la Fecha" value="{{old('fecha_devolucion')}}">
    ...
    name="libro_id"  id="libro_id" placeholder="Ingrese el Id del Libro" value="{{old('libro_id')}}">
