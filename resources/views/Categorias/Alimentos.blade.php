...
@section('todo')
    ...
    <section class="custom-bg">
        <div class="container py-4">
            <div class="text-center mx-auto" style="width: 800px;">
                <h1 class="display-3 text-success"><b>Alimentos</b></h1>
                <p class="lead my-auto">Descubre delicias extraordinarias para endulzar tus momentos especiales.
                    Encuentra los mejores dulces y postres que complementarán tu estilo y satisfarán tu paladar.</p>
            </div>
            ...
            <div class="row my-4 py-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaAlimentos', ['precio' => 'TODOS']) }}">Todos</a></li>
                            <li><a class="dropdown-item" href="{{ route('CategoriaAlimentos', ['precio' => 'CARO']) }}">Más
                                    caro</a></li>
                            <li><a class="dropdown-item" href="{{ route('CategoriaAlimentos', ['precio' => 'BARATO']) }}">Más
                                    barato</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaAlimentos', ['nombre' => 'ASCENDENTE']) }}">Ascendente</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaAlimentos', ['nombre' => 'DESCENDENTE']) }}">Descendente</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaAlimentos', ['nombre' => 'TODOS']) }}">Todos</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <form class="d-flex" action="{{ route('CategoriaAlimentos') }}" method="get">
                    ...
                    @for ($page = $start; $page <= $end; $page++)
                        <li class="page-item pagination-item @if ($page == $currentPage) active @endif">
                            <a class="page-link  shadow-sm  text-dark @if ($page == $currentPage) bg-success text-white @endif"
                                href="{{ route('CategoriaAlimentos', ['page' => $page]) }}">{{ $page }}</a>
                        </li>
                    @endfor
