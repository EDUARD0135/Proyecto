...
@section('todo')
    ...
    <section class="custom-bg">
        <div class="container py-4">
            <div class="text-center mx-auto" style="width: 950px;">
                <h1 class="display-3 text-success"><b>Ropa</b></h1>
                <p class="lead">Descubre las últimas tendencias en moda para realzar tu estilo y destacar en cualquier ocasión. 
                     Encuentra las prendas más elegantes y cómodas que se adaptarán a tu personalidad y satisfarán tus preferencias 
                     de moda.</p>
            </div>
            ...
            <div class="row my-4 py-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaRopa', ['precio' => 'TODOS']) }}">Todos</a></li>
                            <li><a class="dropdown-item" href="{{ route('CategoriaRopa', ['precio' => 'CARO']) }}">Más
                                    caro</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaRopa', ['precio' => 'BARATO']) }}">Más barato</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaRopa', ['nombre' => 'ASCENDENTE']) }}">Ascendente</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaRopa', ['nombre' => 'DESCENDENTE']) }}">Descendente</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('CategoriaRopa', ['nombre' => 'TODOS']) }}">Todos</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <form class="d-flex" action="{{ route('CategoriaRopa') }}" method="get">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <a href="{{ route('ShowProducto', ['id' => $producto->id]) }}">
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                <p class="h4 mb-0"><b>Lps {{ $producto->precio }}</b></p>
                                <div class="d-flex">
                    ...
                    @for ($page = $start; $page <= $end; $page++)
                        <li class="page-item pagination-item @if ($page == $currentPage) active @endif">
                            <a class="page-link  shadow-sm  text-dark @if ($page == $currentPage) bg-success text-white @endif"
                                href="{{ route('CategoriaRopa', ['page' => $page]) }}">{{ $page }}</a>
                        </li>
                    @endfor
