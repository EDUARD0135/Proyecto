                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h1 class="h2 text-success"><b>{{ $oferta->nombre }}</b></h1>
                            </div>

                            <div class="mt-2">
                                <a type="submit" class="btn btn-success">Me Gusta ({{ $likes }})</a>

                                <a type="submit" class="btn btn-danger mx-2">No me Gusta ({{ $dislikes }})</a>
                            </div>
